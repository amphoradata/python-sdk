...
class CreateAmphoraUser(object):
    ...
    def __init__(self, phone_number=None, about=None, full_name=None, user_name=None, password=None, confirm_password=None, email=None, local_vars_configuration=None):  # noqa: E501
