...
class CreateTermsOfUse(object):
    ...
    """
    openapi_types = {'name': 'str', 'contents': 'str'}

    attribute_map = {'name': 'name', 'contents': 'contents'}
    ...
    @property
    def name(self):
        """Gets the name of this CreateTermsOfUse.  # noqa: E501


        :return: The name of this CreateTermsOfUse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateTermsOfUse.


        :param name: The name of this CreateTermsOfUse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def contents(self):
        """Gets the contents of this CreateTermsOfUse.  # noqa: E501


        :return: The contents of this CreateTermsOfUse.  # noqa: E501
        :rtype: str
        """
    ...
    def contents(self, contents):
        """Sets the contents of this CreateTermsOfUse.


        :param contents: The contents of this CreateTermsOfUse.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateTermsOfUse):
            return False
