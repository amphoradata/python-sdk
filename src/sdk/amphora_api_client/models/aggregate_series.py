...
class AggregateSeries(object):
    ...
    def __init__(self, time_series_id=None, search_span=None, filter=None, interval=None, projected_variables=None, inline_variables=None, local_vars_configuration=None):  # noqa: E501
