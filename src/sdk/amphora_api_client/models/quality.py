...
class Quality(object):
    ...
    """
    openapi_types = {
        'accuracy': 'OneOfQualityLevels',
        'completeness': 'OneOfQualityLevels',
        'granularity': 'OneOfQualityLevels',
        'reliability': 'OneOfQualityLevels'
    }
