...
class OrganisationAccessRule(object):
    ...
    def __init__(self, id=None, allow_or_deny=None, priority=None, organisation_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def organisation_id(self, organisation_id):
        ...
        if (self.local_vars_configuration.client_side_validation and
                organisation_id is not None and len(organisation_id) < 1):
            raise ValueError("Invalid value for `organisation_id`, length must be greater than or equal to `1`")  # noqa: E501
