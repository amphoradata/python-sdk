...
class AppLocationBase(object):
    ...
    def __init__(self,
        ...
        """AppLocationBase - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def origin(self):
        """Gets the origin of this AppLocationBase.  # noqa: E501

        Gets or sets the expected origin from a XMLHttpRequest Must not end in '/'.  # noqa: E501

        :return: The origin of this AppLocationBase.  # noqa: E501
        :rtype: str
        """
        return self._origin
    ...
    def origin(self, origin):
        """Sets the origin of this AppLocationBase.

        Gets or sets the expected origin from a XMLHttpRequest Must not end in '/'.  # noqa: E501

        :param origin: The origin of this AppLocationBase.  # noqa: E501
        :type: str
        """
    ...
    def allowed_redirect_paths(self):
        """Gets the allowed_redirect_paths of this AppLocationBase.  # noqa: E501

        Gets or sets allowed redirects after login, relative to Origin. Must begin with a '/'.  # noqa: E501

        :return: The allowed_redirect_paths of this AppLocationBase.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def allowed_redirect_paths(self, allowed_redirect_paths):
        """Sets the allowed_redirect_paths of this AppLocationBase.

        Gets or sets allowed redirects after login, relative to Origin. Must begin with a '/'.  # noqa: E501

        :param allowed_redirect_paths: The allowed_redirect_paths of this AppLocationBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def post_logout_redirects(self):
        """Gets the post_logout_redirects of this AppLocationBase.  # noqa: E501

        Gets or sets the allowed redirect after logout. Must be an absolute url.  # noqa: E501

        :return: The post_logout_redirects of this AppLocationBase.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def post_logout_redirects(self, post_logout_redirects):
        """Sets the post_logout_redirects of this AppLocationBase.

        Gets or sets the allowed redirect after logout. Must be an absolute url.  # noqa: E501

        :param post_logout_redirects: The post_logout_redirects of this AppLocationBase.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AppLocationBase):
            return False
