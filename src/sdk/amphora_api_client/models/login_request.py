...
class LoginRequest(object):
    ...
    def password(self, password):
        ...
        if (self.local_vars_configuration.client_side_validation
                and password is not None and len(password) < 1):
            raise ValueError(
                "Invalid value for `password`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    @property
    def claims(self):
        """Gets the claims of this LoginRequest.  # noqa: E501


        :return: The claims of this LoginRequest.  # noqa: E501
        :rtype: list[LoginClaim]
        """
        return self._claims

    @claims.setter
    def claims(self, claims):
        """Sets the claims of this LoginRequest.


        :param claims: The claims of this LoginRequest.  # noqa: E501
        :type: list[LoginClaim]
        """
