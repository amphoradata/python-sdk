...
class AmphoraUser(object):
    ...
    def __init__(self, phone_number=None, about=None, full_name=None, user_name=None, id=None, email=None, organisation_id=None, last_modified=None, local_vars_configuration=None):  # noqa: E501
    ...
    def phone_number(self, phone_number):
        ...
        if (self.local_vars_configuration.client_side_validation and
                phone_number is not None and len(phone_number) < 6):
            raise ValueError("Invalid value for `phone_number`, length must be greater than or equal to `6`")  # noqa: E501
