...
import amphora_api_client.models
from amphora_api_client import rest
...
class ApiClient(object):
    ...
    def __init__(self,
        ...
        self.user_agent = 'OpenAPI-Generator/0.9.9/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(amphora_api_client.models, klass)
