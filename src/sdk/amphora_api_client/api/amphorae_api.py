...
class AmphoraeApi(object):
    ...
    def amphorae_files_list_files(self, id, **kwargs):  # noqa: E501
        ...
        :param int take: Gets or sets how many files to return. Defaults to 64.
        :param int skip: Gets or sets how many files to skip before returning. Defaults to 0.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def amphorae_files_read_file_attributes(self, id, file,
                                            **kwargs):  # noqa: E501
        """Get's the attributes of a file.  # noqa: E501
