...
class GeoApi(object):
    ...
    def geo_lookup_location(self, **kwargs):  # noqa: E501
        """Executes a fuzzy location search.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.geo_lookup_location(async_req=True)
        >>> result = thread.get()
        ...
        return self.geo_lookup_location_with_http_info(**kwargs)  # noqa: E501

    def geo_lookup_location_with_http_info(self, **kwargs):  # noqa: E501
        """Executes a fuzzy location search.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.geo_lookup_location_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method geo_lookup_location" % key)
