...
class OrganisationsApi(object):
    ...
    def account_get_plan(self, id, **kwargs):  # noqa: E501
        """Get's an Organisation's plan information.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_get_plan(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.account_get_plan_with_http_info(id, **kwargs)  # noqa: E501

    def account_get_plan_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get's an Organisation's plan information.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.account_get_plan_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method account_get_plan" % key)
    ...
    def terms_and_conditions_create(self, id, terms_and_conditions,
                                    **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.terms_and_conditions_create_with_http_info(
            id, terms_and_conditions, **kwargs)  # noqa: E501

    def terms_and_conditions_create_with_http_info(self, id,
        ...
        all_params = ['id', 'terms_and_conditions',
                      'x_amphoradata_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method terms_and_conditions_create" %
                                   key)
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'terms_and_conditions' is set
        if self.api_client.client_side_validation and (
                'terms_and_conditions' not in local_var_params or  # noqa: E501
                local_var_params['terms_and_conditions'] is None
        ):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `terms_and_conditions` when calling `terms_and_conditions_create`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/Organisations/{id}/TermsAndConditions',
            'POST',
            path_params,
            query_params,
            header_params,
    ...
    def terms_and_conditions_read(self, id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.terms_and_conditions_read_with_http_info(
            id, **kwargs)  # noqa: E501

    def terms_and_conditions_read_with_http_info(self, id,
                                                 **kwargs):  # noqa: E501
        """Get's a list of an Organisation's Terms and Conditions.  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method terms_and_conditions_read" %
                                   key)
            local_var_params[key] = val
        del local_var_params['kwargs']
