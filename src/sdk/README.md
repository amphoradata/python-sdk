...
*AmphoraeApi* | [**amphorae_signals_upload_signal_batch**](docs/AmphoraeApi.md#amphorae_signals_upload_signal_batch) | **POST** /api/amphorae/{id}/signals/batchvalues | Uploads values in batch to an Amphora signal(s).
*AmphoraeApi* | [**amphorae_signals_upload_signal_batch2**](docs/AmphoraeApi.md#amphorae_signals_upload_signal_batch2) | **POST** /api/amphorae/{id}/batchSignalValues | Uploads values in batch to an Amphora signal(s).
