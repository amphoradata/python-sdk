...
*ApplicationsApi* | [**applications_create_application2**](docs/ApplicationsApi.md#applications_create_application2) | **GET** /api/applications/{id} | Gets an application by Id, if it exists.
