...
class AuthenticationApi(object):
    ...
    def api_authentication_request_post(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.api_authentication_request_post(async_req=True)
        >>> result = thread.get()
    ...
    def api_authentication_request_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_authentication_request_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method api_authentication_request_post" % key
                )
