...
class AmphoraeApi(object):
    ...
    def amphorae_create_with_http_info(self, create_amphora_dto, **kwargs):  # noqa: E501
        ...
        all_params = ['create_amphora_dto', 'x_amphoradata_version']  # noqa: E501
    ...
    def amphorae_create_file_request(self, id, file, **kwargs):  # noqa: E501
        """Creates a file. Returns a blob URL to upload to.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.amphorae_create_file_request(id, file, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.amphorae_create_file_request_with_http_info(id, file, **kwargs)  # noqa: E501

    def amphorae_create_file_request_with_http_info(self, id, file, **kwargs):  # noqa: E501
        """Creates a file. Returns a blob URL to upload to.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.amphorae_create_file_request_with_http_info(id, file, async_req=True)
        >>> result = thread.get()
    ...
    def amphorae_create_signal_with_http_info(self, id, signal_dto, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'signal_dto', 'x_amphoradata_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def amphorae_update(self, id, amphora_extended_dto, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str id: Amphora Id. (required)
        :param AmphoraExtendedDto amphora_extended_dto: Information to update. Nulls are NOT ignored. (required)
        :param str x_amphoradata_version: API Version Number
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
    ...
    def amphorae_update_with_http_info(self, id, amphora_extended_dto, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'amphora_extended_dto', 'x_amphoradata_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def amphorae_upload_file(self, id, file, **kwargs):  # noqa: E501
        """Set's the contents of a file. The request body becomes the content.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.amphorae_upload_file(id, file, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.amphorae_upload_file_with_http_info(id, file, **kwargs)  # noqa: E501

    def amphorae_upload_file_with_http_info(self, id, file, **kwargs):  # noqa: E501
        """Set's the contents of a file. The request body becomes the content.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.amphorae_upload_file_with_http_info(id, file, async_req=True)
        >>> result = thread.get()
    ...
    def amphorae_upload_signal(self, id, request_body, **kwargs):  # noqa: E501
        """amphorae_upload_signal  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.amphorae_upload_signal(id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.amphorae_upload_signal_with_http_info(id, request_body, **kwargs)  # noqa: E501

    def amphorae_upload_signal_with_http_info(self, id, request_body, **kwargs):  # noqa: E501
        """amphorae_upload_signal  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.amphorae_upload_signal_with_http_info(id, request_body, async_req=True)
        >>> result = thread.get()
    ...
    def amphorae_upload_signal_batch(self, id, request_body, **kwargs):  # noqa: E501
        """amphorae_upload_signal_batch  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.amphorae_upload_signal_batch(id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.amphorae_upload_signal_batch_with_http_info(id, request_body, **kwargs)  # noqa: E501

    def amphorae_upload_signal_batch_with_http_info(self, id, request_body, **kwargs):  # noqa: E501
        """amphorae_upload_signal_batch  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.amphorae_upload_signal_batch_with_http_info(id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method amphorae_upload_signal_batch" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'request_body' is set
        if self.api_client.client_side_validation and ('request_body' not in local_var_params or  # noqa: E501
                                                        local_var_params['request_body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `request_body` when calling `amphorae_upload_signal_batch`")  # noqa: E501
