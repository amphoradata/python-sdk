...
class ImagesApi(object):
    ...
    def api_organisations_id_profile_jpg_get(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.api_organisations_id_profile_jpg_get(id, async_req=True)
        >>> result = thread.get()
    ...
    def api_organisations_id_profile_jpg_get_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_organisations_id_profile_jpg_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method api_organisations_id_profile_jpg_get" % key
                )
        ...
        if ('id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `api_organisations_id_profile_jpg_get`")  # noqa: E501
