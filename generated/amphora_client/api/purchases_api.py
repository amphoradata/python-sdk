...
class PurchasesApi(object):
    ...
    def purchases_purchase(self, id, x_amphoradata_version, **kwargs):  # noqa: E501
        """Purchases an Amphora as the logged in user.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.purchases_purchase(id, x_amphoradata_version, async_req=True)
        >>> result = thread.get()
        ...
        return self.purchases_purchase_with_http_info(id, x_amphoradata_version, **kwargs)  # noqa: E501

    def purchases_purchase_with_http_info(self, id, x_amphoradata_version, **kwargs):  # noqa: E501
        """Purchases an Amphora as the logged in user.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.purchases_purchase_with_http_info(id, x_amphoradata_version, async_req=True)
        >>> result = thread.get()
        ...
        if ('x_amphoradata_version' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `x_amphoradata_version` when calling `purchases_purchase`")  # noqa: E501
