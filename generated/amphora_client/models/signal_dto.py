...
class SignalDto(object):
    ...
    def _property(self, _property):
        ...
        if (self.local_vars_configuration.client_side_validation and
                _property is not None and not re.search(r'^[a-zA-Z]{1,20}$', _property)):  # noqa: E501
            raise ValueError(r"Invalid value for `_property`, must be a follow pattern or equal to `/^[a-zA-Z]{1,20}$/`")  # noqa: E501
