...
class SignalDto(object):
    ...
    def __init__(self, id=None, _property=None, value_type=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def _property(self):
        """Gets the _property of this SignalDto.  # noqa: E501


        :return: The _property of this SignalDto.  # noqa: E501
        :rtype: str
        """
    ...
    def _property(self, _property):
        """Sets the _property of this SignalDto.


        :param _property: The _property of this SignalDto.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                _property is not None and not re.search(r'^[a-zA-Z_]{3,20}$', _property)):  # noqa: E501
            raise ValueError(r"Invalid value for `_property`, must be a follow pattern or equal to `/^[a-zA-Z_]{3,20}$/`")  # noqa: E501
