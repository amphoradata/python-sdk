...
class AmphoraExtendedDto(object):
    ...
    def __init__(self, id=None, is_deleted=None, created_date=None, name=None, price=None, labels=None, organisation_id=None, terms_and_conditions_id=None, description=None, lat=None, lon=None, local_vars_configuration=None):  # noqa: E501
