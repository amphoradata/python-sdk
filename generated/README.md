...
*MarketApi* | [**market_find**](docs/MarketApi.md#market_find) | **GET** /api/market | Finds Amphora using a fuzzy search
...
*OrganisationsApi* | [**organisations_accept_invitation**](docs/OrganisationsApi.md#organisations_accept_invitation) | **GET** /api/organisations/{id}/invitations | Accept an invitation to an organisation.
...
*OrganisationsApi* | [**organisations_invite_to_organisation**](docs/OrganisationsApi.md#organisations_invite_to_organisation) | **POST** /api/organisations/{id}/invitations | Invite a user/ email address to your organisation.
