...
*AmphoraeApi* | [**amphorae_upload_signal_batch**](docs/AmphoraeApi.md#amphorae_upload_signal_batch) | **POST** /api/amphorae/{id}/signals/batchvalues | 
...
*OrganisationRestrictionApi* | [**organisation_restriction_create**](docs/OrganisationRestrictionApi.md#organisation_restriction_create) | **POST** /api/organisations/{id}/restrictions | Restricts an organisation from accessing data.
*OrganisationRestrictionApi* | [**organisation_restriction_delete**](docs/OrganisationRestrictionApi.md#organisation_restriction_delete) | **DELETE** /api/organisations/{id}/restrictions/{targetOrganisationId} | Deletes a restriction.
