...
# **users_create**
> str users_create(x_amphoradata_version, user_dto)
...
try:
    # Creates a new User. Returns the password.
    api_response = api_instance.users_create(x_amphoradata_version, user_dto)
    pprint(api_response)
...
# **users_read_self**
> UserDto users_read_self(x_amphoradata_version)
...
try:
    # Get's logged in users information.
    api_response = api_instance.users_read_self(x_amphoradata_version)
    pprint(api_response)
except ApiException as e:
